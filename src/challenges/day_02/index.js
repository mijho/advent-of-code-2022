...
if (process.argv[1] === fileURLToPath(import.meta.url)) {
    console.log(`The total score if following the guide Part 1: ${await calulateFinalScore(1, './input.txt')}`);
    console.log(`The total score if following the guide Part 2: ${await calulateFinalScore(2, './input.txt')}`);
};
